...
const ElectionsPage = () => {
    ...
    return (
        <div className="font-montserrat">
            <div className="flex gap-1 items-center bg-red-50 w-fit px-2 py-1 rounded-3xl border border-red-600">
            ...
            <div className="flex gap-4 items-center">
                ...
                <div className="flex gap-1 text-gray-700">
                    ...
                    <p className="text-[13px]"> Ends on the {election.duration}st</p>
                </div>
            </div>
        </div>
    );
