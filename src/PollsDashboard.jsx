                ...
                {IsLoading ? Array(6).fill(0).map((_, i) => (
                    ...
                    <div key={poll.id} className='w-full h-fit rounded-lg bg-white shadow-md p-6 max-[840px]:w-full'>
                        ...
                        <div className='text-gray-500 flex justify-between '>
                            <div className="flex items-center gap-4 max-sm:gap-1 max-sm:text-[13px]">
                                ...
                                <span className='flex items-center gap-1'>
                                    ...
                                    <p className='font-raleway text-[15px] max-sm:text-[13px]'>{poll.createdAt.toDate().toLocaleDateString()}</p>
                                </span>
                            </div>
