...
const PollsDashboard = ({ setactiveTab }) => {
    ...
    return (
        <div>
            ...
            <div>
                <div className='w-fit rounded-lg bg-white shadow-md p-6'>
                    <div className=''>
                    ...
                    <div className='grid gap-y-3'>
                        <div className='w-100 h-10 bg-blue-50 flex items-center justify-between rounded-md'>
                            <div className='w-65 h-10 bg-blue-100 flex items-center rounded-md'>
                                <p className='ml-2'>Ishowspeed</p>
                            </div>
                            <p className='mr-2 font-sans text-blue-500'>{percentage}%</p>
                        </div>
                        <div className='w-100 h-10 bg-blue-50 flex items-center justify-between rounded-md'>
                            <div className='w-25 h-10 bg-blue-100 flex items-center rounded-md'>
                                <p className='ml-2'>Mirabel</p>
                            </div>
                            <p className='mr-2 font-sans text-blue-500'>{25}%</p>
                        </div>
                        <div className='w-100 h-10 bg-blue-50 flex items-center justify-between rounded-md'>
                            <div className='w-10 h-10 bg-blue-100 flex items-center rounded-md'>
                    ...
                    <div className='text-gray-500 flex justify-between '>
                        ...
                        <span className='flex items-center'>
                            ...
                            <p className='font-raleway'>Ends in 3h</p>
                        </span>
                    </div>
                </div>
