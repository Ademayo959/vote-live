                    ...
                    <div className="grid grid-cols-3 gap-12 my-12 max-sm:grid-cols-1">
                        <div className="w-90 rounded-2xl bg-white shadow-lg h-70 grid grid-rows-[20%_10%_10%_50%] gap-2 py-6 px-6 pt-2 max-sm:px-3 max-sm:w-[99%]">
                            ...
                            <div className="mb-0 mt-0">
                                <h1 className="text-xl font-extrabold max-sm:text-[4.75vw]">Engineering Faculty President</h1>
                            </div>
                        ...
                        <div className="w-90 rounded-2xl bg-white shadow-lg h-70 grid grid-rows-[20%_10%_10%_50%] gap-2 py-6 px-6 pt-2 max-sm:px-3 max-sm:w-[99%]">
                            ...
                            <div className="mb-0 mt-0">
                                <h1 className="text-xl font-extrabold max-sm:text-[4.75vw]">Best Campus Football Team</h1>
                            </div>
                            <div className="flex gap-2 items-center">
                                <div className="flex items-center text-gray-500 gap-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 max-sm:w-4 max-sm:h-4">
                        ...
                        <div className="w-90 rounded-2xl bg-white shadow-lg h-70 grid grid-rows-[20%_10%_10%_50%] gap-2 py-6 px-6 pt-2 max-sm:px-3 max-sm:w-[99%]">
                            ...
                            <div className="mb-0 mt-0">
                                <h1 className="text-xl font-extrabold max-sm:text-[4.75vw]">Computer Science Dept. Sec</h1>
                            </div>
                            <div className="flex gap-2 items-center">
                                <div className="flex items-center text-gray-500 gap-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 max-sm:w-4 max-sm:h-4">
