...
const CreateElectionModal = ({setIsCreateElectionModal}) => {
    ...
    return (
        <div>
            <div  onClick={(e) => e.stopPropagation()} className="bg-accent-blue w-[95%] max-w-3xl font-montserrat fixed top-1/2 left-1/2 -translate-x-1/2 z-100 -translate-y-1/2 max-h-[90vh] overflow-y-auto">
